...
export const getPost = async (req, res) => {
    const post = await Post.findOne({ slug: req.params.slug })
        ...
        .select("title category desc content img createdAt");
...
const imagekit = new ImageKit({
    urlEndpoint: "https://ik.imagekit.io/umgtihskz",
    publicKey: "public_m/nt85FmjqZbftG1n9xIjdekIuc=",
    privateKey: "private_FJP2aUbkcFlCPUhZf1/iYOEhnZ0="
});
